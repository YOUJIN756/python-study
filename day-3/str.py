...
print(text.rstrip('*')) #오른쪽 *제거, .lstrip():왼쪽부
...
arr_Str=input('Input String : ').split('-') #inforrmation-technology -> - 기준으로 쪼갬 [0][1] 나누어서
...
#technology 에서 i 찾음 -> find 할 때 없으면 -1
# -1 + arr_val[2] -> 6 =5


st= input("영어 1글자를 입력하세요")
if st.isupper(): #대문자냐 -> true 아니면 ->false
   print(st.lower())    #true일 때 수행 -> 소문자로 변경
